...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber tag6_subscriber = n.subscribe("tag6_filter", 1, tag6_cb);
    ros::Subscriber tag7_subscriber = n.subscribe("tag7_filter", 1, tag7_cb); 
    ros::Subscriber tag8_subscriber = n.subscribe("tag8_filter", 1, tag8_cb);
    ros::Subscriber tag10_subscriber = n.subscribe("tag10_filter", 1, tag10_cb); 
    ros::Subscriber tag20_subscriber = n.subscribe("tag20_filter", 1, tag20_cb);
    ...
    while(ros::ok())
    {
        ...
        // robot_hand.pose.position.x = 0;
        // robot_hand.pose.position.y = 0;
        // robot_hand.pose.position.z = 0;
        // robot_hand.pose.orientation.x = 0;
        // robot_hand.pose.orientation.y = 0;
        // robot_hand.pose.orientation.z = 0;
        // robot_hand.pose.orientation.w = 1;
