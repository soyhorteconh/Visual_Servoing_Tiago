...
{
    Eigen::Vector3d axis = inria::MatrixToAxis(mat1);
    Eigen::Matrix3d mat2 = inria::AxisToMatrix(axis);
...
{
    Eigen::Matrix3d mat = inria::AxisToMatrix(axis1);
    Eigen::Vector3d axis2 = inria::MatrixToAxis(mat);
