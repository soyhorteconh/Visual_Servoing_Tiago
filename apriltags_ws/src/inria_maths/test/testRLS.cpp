#include <iostream>
#include <inria_maths/RecursiveLeastSquares.hpp>
#include <inria_plot/Plot.hpp>
#include <inria_utils/Random.hpp>

void testSimple()
{
    inria::RecursiveLeastSquares model;
    ...
    plot
        ...
        .show();
    plot
        .plot("x", "y", inria::Plot::LinesPoints, "time")
        .show();
    plot
    ...
    plot
        ...
        .show();
    plot
        .plot("x", "y", "signal", inria::Plot::Points)
        .plot("x", "y", "target", inria::Plot::Points)
        .plot("x", "y", "prediction_before", inria::Plot::Points)
        .plot("x", "y", "prediction_after", inria::Plot::Points)
        .show();
    plot
        .plot("time", "signal")
        .plot("time", "target")
