...
#include <inria_utils/Random.hpp>
#include <inria_maths/ControlDampedIntegral.hpp>

void testControlDampedIntegral(inria::Plot& plot)
{
    double dt = 0.001;
    double pos = 0.0;
    double vel = 0.0;
    ...
    inria::SplineCubic splineTarget;
    ...
    inria::ControlDampedIntegral control(1.0/dt);
    ...
    for (double t=0.0;t<14.0;t+=dt) {
        ...
        double forceFrictionStatic = -frictionStatic*inria::Sign(vel);
